...
class ProfesorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post profesors_url, params: { profesor: { apellidos: @profesor.apellidos, correo: @profesor.correo, nombres: @profesor.nombres, telefono: @profesor.telefono } }
    end
  ...
  test "should update profesor" do
    patch profesor_url(@profesor), params: { profesor: { apellidos: @profesor.apellidos, correo: @profesor.correo, nombres: @profesor.nombres, telefono: @profesor.telefono } }
