...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { detalle: @evento.detalle, fechaEvento: @evento.fechaEvento, imagen: @evento.imagen, pais: @evento.pais, titulo: @evento.titulo } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { detalle: @evento.detalle, fechaEvento: @evento.fechaEvento, imagen: @evento.imagen, pais: @evento.pais, titulo: @evento.titulo } }
