...
class MateriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post materia_url, params: { materium: { colegio_id: @materium.colegio_id, horario: @materium.horario, nombre: @materium.nombre, profesor_id: @materium.profesor_id } }
    end
  ...
  test "should update materium" do
    patch materium_url(@materium), params: { materium: { colegio_id: @materium.colegio_id, horario: @materium.horario, nombre: @materium.nombre, profesor_id: @materium.profesor_id } }
